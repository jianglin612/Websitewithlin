...
const companies: Company[] = [
  ...
  { name: 'CardNow', website: '', description: 'Digital gift card platform for online gifting', stage: 'Seed', investors: [], source: 'Commerce Ventures' },
  ...
  { name: 'Harvest', website: '', description: 'AI wealth management and financial health platform', stage: 'Series B', investors: [], source: 'Commerce Ventures' },
  { name: 'HMB', website: '', description: 'Hybrid checking/savings account with high APY', stage: 'Acquired', investors: [], source: 'Commerce Ventures' },
  ...
  { name: 'Ledgible', website: '', description: 'Crypto tax and accounting software', stage: 'Series B', investors: [], source: 'Commerce Ventures' },
  { name: 'Liberate', website: '', description: 'Global payments and financial infrastructure', stage: 'Series B', investors: [], source: 'Commerce Ventures' },
  { name: 'Linqia', website: '', description: 'Influencer marketing platform with AI optimization', stage: 'Series C', investors: [], source: 'Commerce Ventures' },
  { name: 'Love Local', website: '', description: 'Curated directory of independent local retailers', stage: 'Series B', investors: [], source: 'Commerce Ventures' },
  { name: 'M10', website: '', description: 'Bank-grade digital currency payment rail', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'Marpipe', website: '', description: 'Multivariate ad testing and creative intelligence', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'Me&U', website: '', description: 'At-table ordering and payment platform', stage: 'Series C', investors: [], source: 'Commerce Ventures' },
  { name: 'Mishipay', website: '', description: 'Mobile self-checkout and payment technology', stage: 'Series B', investors: [], source: 'Commerce Ventures' },
  { name: 'Monark Markets', website: '', description: 'Private market access infrastructure for retail', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'Mulberry', website: '', description: 'Product protection and insurance plans', stage: 'Series B', investors: [], source: 'Commerce Ventures' },
  { name: 'Neural Payments', website: '', description: 'P2P payments and fraud prevention for banks', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'Ovation CXM', website: '', description: 'Customer journey orchestration and experience management', stage: 'Growth', investors: [], source: 'Commerce Ventures' },
  { name: 'PayAmigo', website: '', description: 'Emerging market payment platform', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'Paystand', website: '', description: 'B2B blockchain payments without transaction fees', stage: 'Series B', investors: [], source: 'Commerce Ventures' },
  { name: 'Pensa', website: '', description: 'Computer vision retail inventory management', stage: 'Series B', investors: [], source: 'Commerce Ventures' },
  { name: 'Pesto', website: '', description: 'Asset-backed credit card fintech', stage: 'Seed', investors: [], source: 'Commerce Ventures' },
  { name: 'Portless', website: '', description: 'Direct fulfillment from China to global customers', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'Precision GX', website: '', description: 'Healthcare payment integrity and fraud detection', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'Prime Trust', website: '', description: 'Digital asset custody and financial infrastructure', stage: 'Defunct', investors: [], source: 'Commerce Ventures' },
  { name: 'Purple Dot', website: '', description: 'Fashion "wait and save" payment option', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'Qualtik', website: '', description: 'Loan portfolio and CRE risk analysis software', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'Quest Analytics', website: '', description: 'Banking CRM and sales effectiveness platform', stage: 'Acquired', investors: [], source: 'Commerce Ventures' },
  { name: 'Radius', website: '', description: 'B2B payments platform for financial services', stage: 'Series B', investors: [], source: 'Commerce Ventures' },
  { name: 'Rally', website: '', description: 'Fleet finance platform streamlining payments', stage: 'Pre-Seed', investors: [], source: 'Commerce Ventures' },
  { name: 'Resolve Pay', website: '', description: 'B2B embedded buy-now-pay-later solution', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'RetailNext', website: '', description: 'Retail analytics and occupancy management', stage: 'Series E', investors: [], source: 'Commerce Ventures' },
  { name: 'Saving Star', website: '', description: 'Cash back rewards at supermarkets', stage: 'Acquired', investors: [], source: 'Commerce Ventures' },
  { name: 'Session', website: '', description: 'Search returned conference sessions only', stage: 'N/A', investors: [], source: 'Commerce Ventures' },
  { name: 'Simon Data', website: '', description: 'Connected customer data platform', stage: 'Series D', investors: [], source: 'Commerce Ventures' },
  { name: 'Snapsheet', website: '', description: 'Cloud-native insurance claims management', stage: 'Series E2', investors: [], source: 'Commerce Ventures' },
  { name: 'Steady App', website: '', description: 'Income verification for gig workers', stage: 'Series B', investors: [], source: 'Commerce Ventures' },
  { name: 'Tabs', website: '', description: 'Finance automation contract-to-cash lifecycle', stage: 'Series B', investors: [], source: 'Commerce Ventures' },
  { name: 'Theatro', website: '', description: 'Voice-controlled mobile enterprise platform', stage: 'Acquired', investors: [], source: 'Commerce Ventures' },
  { name: 'Treinta', website: '', description: 'Finance inventory sales tools SMBs', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'Tulip', website: '', description: 'Manufacturing cloud operations software', stage: 'Series D', investors: [], source: 'Commerce Ventures' },
  { name: 'Unison', website: '', description: 'Home equity co-investment platform', stage: 'Series C', investors: [], source: 'Commerce Ventures' },
  { name: 'Updater', website: '', description: 'Relocation services technology platform', stage: 'Private', investors: [], source: 'Commerce Ventures' },
  { name: 'Vitable Health', website: '', description: 'Healthcare platform for underinsured workers', stage: 'Series A', investors: [], source: 'Commerce Ventures' },
  { name: 'Volition Beauty', website: '', description: 'Beauty product customization platform', stage: 'Seed', investors: [], source: 'Commerce Ventures' },
  { name: 'Weather Promise', website: '', description: 'Weather-triggered travel protection payouts', stage: 'Early Stage', investors: [], source: 'Commerce Ventures' },
  { name: 'Zentist', website: '', description: 'Dental revenue cycle management software', stage: 'Series A', investors: [], source: 'Commerce Ventures' },

  // Graph Ventures
  { name: 'Abhi', website: '', description: 'Pakistani fintech providing earned wage access and payroll financing', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Aperture Data', website: '', description: 'Multimodal AI database platform for unstructured data', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Applied Carbon', website: '', description: 'Agricultural robots converting crop waste to biochar for carbon', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'BigBox', website: '', description: 'Gift experience marketplace in Latin America', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Bizzy', website: '', description: 'Indonesian B2B supply chain logistics platform', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  ...
  { name: 'Circuit and Chisel', website: '', description: 'Agentic AI payments protocol infrastructure provider', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Clearspace', website: '', description: 'Swiss space debris removal and orbital service company', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  ...
  { name: 'Cube Exchange', website: '', description: 'Hybrid crypto exchange with off-chain matching', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Cut and Dry', website: '', description: 'Foodservice B2B commerce platform with AI recommendations', stage: 'Growth', investors: [], source: 'Graph Ventures' },
  { name: 'Dapper Labs', website: '', description: 'NFT and blockchain gaming infrastructure company', stage: 'Series D', investors: [], source: 'Graph Ventures' },
  { name: 'Disclo', website: '', description: 'HR software for disability accommodation request management', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Dub', website: '', description: 'Open-source URL shortener and link attribution platform', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Enjoei', website: '', description: 'Brazilian peer-to-peer secondhand fashion marketplace', stage: 'Public', investors: [], source: 'Graph Ventures' },
  { name: 'Fakespot', website: '', description: 'Product authenticity verification platform, acquired by Mozilla', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Finesse', website: '', description: 'Natural organic cosmetics company specializing in potassium alum', stage: 'Pre-Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Formally', website: '', description: 'Legal tech platform simplifying immigration case management', stage: 'Pre-Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Hang', website: '', description: 'Omnichannel loyalty platform for businesses', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Hashdex', website: '', description: 'Crypto asset management and index fund company', stage: 'Growth', investors: [], source: 'Graph Ventures' },
  { name: 'Helpful', website: '', description: 'AI customer service agent platform for enterprise support', stage: 'N/A', investors: [], source: 'Graph Ventures' },
  { name: 'Hinge', website: '', description: 'Dating app designed for meaningful relationships', stage: 'Acquisition', investors: [], source: 'Graph Ventures' },
  { name: 'Hoodline', website: '', description: 'Hyper-local automated news and data platform', stage: 'Acquisition', investors: [], source: 'Graph Ventures' },
  { name: 'Houseparty', website: '', description: 'Group video chat app, acquired by Epic Games', stage: 'Acquisition', investors: [], source: 'Graph Ventures' },
  { name: 'Hydra', website: '', description: 'GPU infrastructure and wholesale cloud computing provider', stage: 'Series B', investors: [], source: 'Graph Ventures' },
  { name: 'Ipsy', website: '', description: 'Personalized beauty subscription box service', stage: 'Private', investors: [], source: 'Graph Ventures' },
  { name: 'Kelvin', website: '', description: 'Decarbonizes buildings using AI-driven HVAC systems', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Keyway', website: '', description: 'AI platform for real estate revenue and workflow', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Kinara', website: '', description: 'Semiconductor company acquired by NXP', stage: 'Series B', investors: [], source: 'Graph Ventures' },
  { name: 'Koltin', website: '', description: 'Private health insurance for seniors in Mexico', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Lava', website: '', description: 'Modular blockchain developer offering reward tokens', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Lever', website: '', description: 'Talent acquisition software for hiring experiences', stage: 'Series D', investors: [], source: 'Graph Ventures' },
  { name: 'LingoKids', website: '', description: 'Interactive playlearning app for kids worldwide', stage: 'Series D', investors: [], source: 'Graph Ventures' },
  { name: 'Loft', website: '', description: 'Real estate marketplace and platform in Brazil', stage: 'Series E', investors: [], source: 'Graph Ventures' },
  { name: 'Matchday', website: '', description: 'Licensed blockchain soccer gaming with Web3', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Meliuz', website: '', description: 'Cashback platform and Brazilian fintech company', stage: 'Public', investors: [], source: 'Graph Ventures' },
  { name: 'Metadata', website: '', description: 'B2B marketing operating system for automation', stage: 'Series B', investors: [], source: 'Graph Ventures' },
  { name: 'MileIQ', website: '', description: 'Mileage tracking app acquired by Bending Spoons', stage: 'Acquired', investors: [], source: 'Graph Ventures' },
  { name: 'NAS Academy', website: '', description: 'Creator economy platform with tech tools', stage: 'Series B', investors: [], source: 'Graph Ventures' },
  { name: 'Nayapay', website: '', description: 'Pakistani fintech for messaging and payments', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Neuroclues', website: '', description: 'Eye-tracking AI for neurological disorder diagnosis', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Niche', website: '', description: 'College and K-12 school discovery platform', stage: 'Series C', investors: [], source: 'Graph Ventures' },
  { name: 'Opencare', website: '', description: 'Dental care network connecting patients providers', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Papaya Payments', website: '', description: 'Mobile bill payment app with AI understanding', stage: 'Series B', investors: [], source: 'Graph Ventures' },
  { name: 'Particle', website: '', description: 'IoT connectivity platform for developers', stage: 'Series A+', investors: [], source: 'Graph Ventures' },
  { name: 'PicsArt', website: '', description: 'Photo editing and creative tools platform', stage: 'Late Stage', investors: [], source: 'Graph Ventures' },
  { name: 'Pillar', website: '', description: 'Construction technology startup using AI', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Pomelo', website: '', description: 'International money transfer with credit product', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Porch', website: '', description: 'Home improvement marketplace platform', stage: 'Public', investors: [], source: 'Graph Ventures' },
  { name: 'Quinto Andar', website: '', description: 'Brazil real estate rental platform for landlords and renters', stage: 'Series E', investors: [], source: 'Graph Ventures' },
  { name: 'Regent', website: '', description: 'Electric seagliders for sustainable short-haul transportation', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Returnly', website: '', description: 'Returns infrastructure platform acquired by Affirm', stage: 'Acquired', investors: [], source: 'Graph Ventures' },
  { name: 'RideOS', website: '', description: 'Autonomous vehicle fleet management and routing', stage: 'Acquired', investors: [], source: 'Graph Ventures' },
  { name: 'SageCare', website: '', description: 'AI-powered care navigation system for healthcare', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Saildrone', website: '', description: 'Autonomous ocean-mapping unmanned surface vehicles', stage: 'Series C+', investors: [], source: 'Graph Ventures' },
  { name: 'Sailplan', website: '', description: 'Marine industry data structuring platform', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Scan', website: '', description: 'Direct-access private medical imaging services', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Scenario', website: '', description: 'AI-powered gaming asset generation platform', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'School AI', website: '', description: 'AI-powered teacher assistants and tutors for schools', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Serve Robotics', website: '', description: 'Autonomous sidewalk delivery robots', stage: 'Public', investors: [], source: 'Graph Ventures' },
  { name: 'Skyroot', website: '', description: 'India space launch provider with Vikram rockets', stage: 'Series C', investors: [], source: 'Graph Ventures' },
  { name: 'Somos Internet', website: '', description: 'Fiber-optic broadband network across Latin America', stage: 'Series B', investors: [], source: 'Graph Ventures' },
  { name: 'Spell', website: '', description: 'MLOps platform for deep learning applications', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Sway', website: '', description: 'Compostable seaweed-based bioplastic materials', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Tavrn', website: '', description: 'AI agents for legal workflow automation', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'Very Good Security', website: '', description: 'Zero-data tokenization for payment processing', stage: 'Series C', investors: [], source: 'Graph Ventures' },
  { name: 'VivaReal', website: '', description: 'Brazilian real estate marketplace acquired by Grupo ZAP', stage: 'Acquired', investors: [], source: 'Graph Ventures' },
  { name: 'Wirestock', website: '', description: 'Multimodal AI training data platform from creators', stage: 'Series A', investors: [], source: 'Graph Ventures' },
  { name: 'XY AI Labs', website: '', description: 'Healthcare friction reduction platform', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Yummy', website: '', description: 'Venezuela-based superapp for delivery and ridesharing', stage: 'Series B', investors: [], source: 'Graph Ventures' },
  { name: 'Zeplin', website: '', description: 'Design handoff platform for developers and designers', stage: 'Seed', investors: [], source: 'Graph Ventures' },
  { name: 'Ziina', website: '', description: 'UAE digital payments wallet for small businesses', stage: 'Series A', investors: [], source: 'Graph Ventures' },
